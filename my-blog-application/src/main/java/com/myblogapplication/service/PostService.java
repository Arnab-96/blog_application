...
public class PostService {
    ...
    public List<Post> findFilteredPosts(String author, List<Integer> tagIds, String date) {
        List<Post> allPosts = postRepository.findAll();
        List<Post> filteredPosts = new ArrayList<>();
        for (Post post : allPosts) {
            if (findFilteredPostByAuthor(post, author) &&
    ...
    public boolean findFilteredPostByAuthor(Post post, String author) {
        if (author==null || author.isEmpty()) {
            return true;
        }
        return post.getAuthor() != null && post.getAuthor().equalsIgnoreCase(author);
    }
    ...
    public void updateAuthor(Post post) {
        postRepository.save(post);
    }
}